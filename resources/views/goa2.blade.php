...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="{{asset('css/tour_detail.css')}}" />
<link rel="stylesheet" type="text/css"  href="{{ asset('css/goa2.css') }}"  />
<link rel="stylesheet"  href="{{ asset('css/navigation.css') }}" />

</head>
<body ><div class="bg"><nav id="background2">
   <div id="#logo">
    ...
    <div >
       <button id="day">7 DAYS / 6 NIGHTS</button>
            ...
            <div id="mapframe">
              ...
              <p id="payment" >Per person : <del style="color:red">₹9000/-</del> 8750/- </p>
